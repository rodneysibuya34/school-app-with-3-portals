      ...
      try {
        ...
        if (!response.ok) {
          ...
          if (response.status === 503 || errorData.error?.includes("not configured")) {
            alert("Database not connected! Please add these environment variables in your Vercel project settings:\n\nUPSTASH_REDIS_REST_URL\nUPSTASH_REDIS_REST_TOKEN\n\nGet these from your Upstash dashboard after creating a Redis database.");
            return;
          }
